...
\newcommand{\aseguraml}[2][]{& \textsf{asegura #1: }\ensuremath{#2}\\}
\newcommand{\nuevalinea}[1]{& \hspace{2em} \ensuremath{#1}\\}
\newcommand{\auxilml}[2]{\textsf{aux }\ensuremath{#1 = #2}}
\newcommand{\auxnuevalinea}[1]{\\ \hspace{2em} \ensuremath{#1}}
